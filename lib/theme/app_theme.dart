...
class AppTheme {
  ...
  // Warm Safety Spectrum Color Palette
  static const Color primaryLight = Color(0xFFFF8C42); // Warm sun orange
  static const Color primaryVariantLight = Color(0xFFE67E22); // Deeper orange
  static const Color secondaryLight = Color(0xFF2E86AB); // Cool safety blue
  static const Color secondaryVariantLight = Color(0xFF1F5F8B); // Deeper blue
  ...
  static const Color errorLight = Color(0xFFE76F51); // Coral red
  static const Color successLight = Color(0xFF6A994E); // Natural green
  static const Color warningLight = Color(0xFFF4A261); // Amber
  static const Color accentLight = Color(0xFFFDCB6E); // Soft yellow
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color onSecondaryLight = Color(0xFFFFFFFF);
  static const Color onBackgroundLight = Color(0xFF2D3436); // Deep charcoal
  static const Color onSurfaceLight = Color(0xFF2D3436);
  static const Color onErrorLight = Color(0xFFFFFFFF);

  // Dark theme colors (adapted for wellness theme)
  static const Color primaryDark = Color(0xFFFF8C42);
  static const Color primaryVariantDark = Color(0xFFE67E22);
  static const Color secondaryDark = Color(0xFF2E86AB);
  static const Color secondaryVariantDark = Color(0xFF1F5F8B);
  static const Color backgroundDark = Color(0xFF1A1A1A);
  static const Color surfaceDark = Color(0xFF2D2D2D);
  static const Color errorDark = Color(0xFFE76F51);
  static const Color successDark = Color(0xFF6A994E);
  static const Color warningDark = Color(0xFFF4A261);
  ...
  static const Color shadowLight = Color(0x0AFF8C42); // Warm shadow
  static const Color shadowDark = Color(0x1AFFFFFF);

  // Divider colors
  static const Color dividerLight = Color(0xFFE9ECEF); // Light gray
  static const Color dividerDark = Color(0xFF404040);

  // Text colors for wellness hierarchy
  static const Color textPrimaryLight = Color(0xFF2D3436); // Deep charcoal
  static const Color textSecondaryLight = Color(0xFF636E72); // Medium gray
  static const Color textDisabledLight = Color(0xFF95A5A6); // Light gray
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      onTertiaryContainer: Color(0xFF2D3436),
      error: errorLight,
  ...
  /// Custom text styles for data display using SF Mono
